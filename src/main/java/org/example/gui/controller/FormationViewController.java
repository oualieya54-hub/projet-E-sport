...
import org.example.controller.FormationController;
...
public class FormationViewController {
    ...
    // Backend Controller for DB operations
    private final FormationController backendController = new FormationController();
    ...
    private void loadData() {
        try {
            List<Formation> data = backendController.getAll();
    ...
    void handleAdd(ActionEvent event) {
        if (validateInput()) {
            try {
                ...
                backendController.create(newFormation);
                loadData();
                handleReset(null);
    ...
    void handleUpdate(ActionEvent event) {
        ...
        if (validateInput()) {
            try {
                ...
                backendController.update(selected);
    ...
    void handleDelete(ActionEvent event) {
        ...
        if (selected != null) {
            ...
            if (confirm.getResult() == ButtonType.YES) {
                try {
                    backendController.delete(selected.getIdFormation());
                    loadData();
                    handleReset(null);
    ...
    void handleFilter(ActionEvent event) {
        ...
        try {
            // Get all from DB
            List<Formation> allFormations = backendController.getAll();
